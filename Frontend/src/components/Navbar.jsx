...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 z-50 right-0
            ${sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out":""} `}>
                <div className="navbar">
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className="">
                            <a className="bg-black text-white px-4 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer font-semibold dark:bg-white dark:text-black "
